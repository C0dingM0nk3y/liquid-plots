...
if(run_api){
  ...
  # TEMP WORKAROUND
          ...
          liq.df %<>% subset(grepl("BTC|ETH|SOL|DOGE|GMX|BNB|FTT", liq.df$poolName))  #TEMP
...
```{r plots, results='asis', fig.align='center', fig.height=10, fig.width=8}
...
for (id in poolId_list){
  ...
  pw <- pw + plot_layout(heights = c(6,6,4,2,2), nrow = 5)
  print(pw)
