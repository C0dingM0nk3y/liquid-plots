...
<ul>
  <li>
  PNL (USDT) plots uses "live" IL: that means that something that in the "past" may have been an IL (in case of exit) now look as an impermanet gain (because price of assed has changed meanwhile)\
