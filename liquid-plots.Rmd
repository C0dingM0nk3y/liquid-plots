...
list_examples <- active.DF[grep(active.DF$poolName, pattern = "STG|RUNE|VET|MATIC|OP|ARB"), ]$poolId 
list_stoploss <- active.DF[grep(active.DF$poolName, pattern = "DOGE"), ]$poolId 
